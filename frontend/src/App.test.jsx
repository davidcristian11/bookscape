...
vi.mock("./components/ChatPage", () => ({
  default: () => <h1>Chat Mock</h1>,
}));

vi.mock("./components/AdminPage", () => ({
  default: () => <h1>Admin Mock</h1>,
}));
...
describe("App routing", () => {
  ...
  it("routes authenticated users to chat and admin pages", async () => {
    authState.authenticated = true;
    authState.token = "token-1";
    authState.user = { name: "Admin", role: "admin", roles: ["admin"], is_admin: true };
    push("/chat");
