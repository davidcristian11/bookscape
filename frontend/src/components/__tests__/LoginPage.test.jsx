...
describe("LoginPage", () => {
  ...
  it("prefills recovery email and offers registration recovery", () => {
    ...
    expect(screen.getByText(/server session expired/i)).toBeInTheDocument();
    expect(screen.getByRole("link", { name: /register a new account/i })).toBeInTheDocument();
  });
});
